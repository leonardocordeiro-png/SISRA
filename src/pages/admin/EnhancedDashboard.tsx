...
import {
    ...
    UserCheck, LayoutGrid, Settings, ArrowUpRight, CalendarClock, DoorOpen, ScanLine
} from 'lucide-react';
...
const MODULES = [
    ...
    { to: '/admin/salas',              Icon: DoorOpen,    label: 'Salas de Saída',           accent: '#1F3057' },
    { to: '/admin/cartoes-qr',          Icon: QrCode,      label: 'Gerar Cartões QR',        accent: '#C24B2A' },
    { to: '/admin/qr-autocadastro',     Icon: ScanLine,    label: 'QR de Auto-cadastro',     accent: '#6B3D8F' },
